	...
	public static PlayerPrefsEx main {
		get {
			if(!s_MainCached) {
                ...
                if(s_Main.mapPlayerPrefsEx.Get("Scene"+loadedLevel.buildIndex,null)!=null) {
                    s_Main=s_Main.LoadPlayerPrefs("Scene"+loadedLevel.buildIndex);
				}
                if(s_Main.mapPlayerPrefsEx.Get(loadedLevel.name,null)!=null) {
                    s_Main=s_Main.LoadPlayerPrefs(loadedLevel.name);
				}
